...
{
    const char* my_code_username = my_username();
    const char* my_fs_username = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_code_username, my_fs_username, "What's mah name?");
}
